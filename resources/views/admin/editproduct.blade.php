           ...
           <i class="fa fa-check-circle text-success" aria-hidden="true"></i> 
            ...
            <form action="/update" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group"><br>
                    ...
                    <input type="text" name="name" class="form-control container" value="{{$data->productname}}">
                    @if($errors->has('name'))
                ...
                <div class="form-group"><br>
                    <label>Brand</label>
                    <input type="text" name="brand" class="form-control container" value="{{$data->brand}}">
                    @if($errors->has('brand'))
                ...
                <div class="form-group"><br>
                    <label>Price</label>
                    <input type="text" name="price" class="form-control container" value="{{$data->price}}">
                    @if($errors->has('price'))
