   ...
   @section('con')
       ...
       <div class="container">
          <div class="table-light border border-dark col-10 jumbtron container">
                <div class=" row">
                <h2 class=" font-weight-bold mt-4 col-6" >Add Coupon</h2>
                <a href="/showcoupon" class="btn btn-dark text-light font-weight-bold ml-4 col-4 mt-4">See Coupons</a><br>
                </div><br>
            ...
            <form action="sendcoupon" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="coupon_code" class="form-control container" placeholder="enter coupon">
                ...
                <div class="form-group">
                    <label>Value</label>
                    <input type="text" name="value" class="form-control container" placeholder="enter value">
                    @if($errors->has('value'))
