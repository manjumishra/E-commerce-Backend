...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4 ml-auto">
      <!-- Brand Logo -->
      <a href="index3.html" class="brand-link bg-warning">
        <img src="{{asset('dist/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-bold h4 text-danger">E-Commerce</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block font-weight-bold text-light"> {{ Auth::user()->firstname}}</a>
          </div>
        </div>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="/addcat" class="nav-link">
                    <i class="far fa-plus-square nav-icon  font-weight-bold" style="color:indianred"></i>
                    <p>
                      Add Category
                    </p>
                  </a>
                ...
                <li class="nav-item">
                  <a href="/showcat" class="nav-link">
                    <i class="far fa-eye  font-weight-bold nav-icon" style="color:teal;"></i>
            ...
            <li class="nav-item">
              <a href="/showproduct" class="nav-link">
                <i class="fa fa-th  font-weight-bold nav-icon" style="color:teal;"></i>
                <p>
                  Products
                </p>
              </a>
            ...
            <li class="nav-item">
              <a href="/showbanner" class="nav-link">
                <i class="nav-icon fa fa-image text-warning font-weight-bold"></i>
                <p>
                  Banner
                </p>
              </a>
            ...
            <li class="nav-item">
              <a href="/showconfig" class="nav-link">
                <i class="nav-icon fa fa-cog text-success font-weight-bold"></i>
                <p>
                  Configuration
                </p>
              </a>
            ...
            <li class="nav-item">
              <a href="/showcoupon" class="nav-link">
                <i class="nav-icon fa fa-gift font-weight-bold" style="color:slateblue;"></i>
                <p>
                  Coupon
                </p>
              </a>
            ...
            <li class="nav-item">
              <a href="/showcms" class="nav-link">
                <i class="nav-icon fa fa-bullseye text-danger"></i>
                <p>
                  CMS
                </p>
              </a>
            ...
            <li class="nav-item">
              <a href="/contacts" class="nav-link">
                <i class="nav-icon fa fa-envelope font-weight-bold"></i>
                <p>
                  Contact Us
                </p>
              </a>
            ...
            <li class="nav-item">
              <a href="" class="nav-link">
                <i class="nav-icon fa fa-flag text-warning"></i>
                <p>
                  Reports
                </p>
                <i class="right fas fa-angle-right"></i>
